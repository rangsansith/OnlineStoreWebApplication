			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div
						...
						<div>
							<c:if test="${cid == -1 }"> <!-- from index  -->
								<a href="${pageContext.request.contextPath }/indexProduct">返回上一页</a>
							</c:if>
							<c:if test="${cid != -1 }">
								<a href="${pageContext.request.contextPath }/findProductByCategory?cid=${cid }&currentPage=${currentPage }">返回上一页</a>
							</c:if>
						</div>
					</div>
				</div>
