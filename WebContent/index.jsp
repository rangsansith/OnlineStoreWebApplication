			...
			<div class="col-md-10">
				...
				<c:forEach items="${hotProductList }" var="product">
					<div class="col-md-2"
						...
						<a href="${pageContext.request.contextPath }/productInfo?pid=${product.pid }&cid=-1"> <img src="${pageContext.request.contextPath }/${product.pimage}"
							width="130" height="130" style="display: inline-block;">
						</a>
						<p>
							<a href="${pageContext.request.contextPath }/productInfo?pid=${product.pid }&cid=-1" style='color: #666'>${product.pname }</a>
						</p>
						<p>
